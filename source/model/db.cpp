...
QString const FIELD_ID_TYPE         = "id_type";
QString const FIELD_COUNT           = "count_";
QString const FIELD_ID_W            = "id_w";
QString const FIELD_ID_H            = "id_h";
QString const FIELD_RESOURCE        = "resource";
...
void DB::initialize() {
    ...
    QString const DB_NAME = DB_DIR + "/inventory.sqlite";
...
TCell DB::getCell(QSize const &pos) {
    ...
    QString query =
        ...
        " where " + TABLE_ITEMS +"." + FIELD_ID_W  + " = " + QString::number(pos.width()) +
        " and "   + TABLE_ITEMS +"." + FIELD_ID_H  + " = " + QString::number(pos.height()) + ";";
